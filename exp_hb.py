...
from dataset_hb import get_dataloader
from utils import train, evaluate
import torch
from get_adj import get_adj_hb


parser = argparse.ArgumentParser(description="GCMDMixer")

parser.add_argument("--config", type=str, default="hb.yaml")
...
if args.modelfolder == "":
    ...
    model.load_state_dict(torch.load("./save/hb/" + args.modelfolder + "/model.pth"))
