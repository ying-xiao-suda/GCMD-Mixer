...
from dataset_shme import get_dataloader
from utils import train, evaluate
import torch
from get_adj import get_adj_shme


parser = argparse.ArgumentParser(description="GCMDMixer")

parser.add_argument("--config", type=str, default="shme.yaml")
...
name = "./save/shme/shme" + current_time + "/"
...
if args.modelfolder == "":
    ...
    model.load_state_dict(torch.load("./save/shme/" + args.modelfolder + "/model.pth"))
